...
var JogadorService = (function () {
    ...
    function JogadorService(http) {
        this.http = http;
        //adicione essa linha
        this.jogadorUrl = 'https://thiagoamaral.herokuapp.com/jogador';
    }
    JogadorService.prototype.getListJogador = function () {
        return this.http.get(this.jogadorUrl)
            .map(function (res) { return res.json(); })
            .catch(this.handleError);
    };
    //método para salvar o jogador
    JogadorService.prototype.salvarJogador = function (jogador) {
    ...
    JogadorService.prototype.deletarJogador = function (id) {
        var headers = new http_2.Headers({ 'Content-Type': 'application/json' });
        var options = new http_2.RequestOptions({ headers: headers });
        return this.http.delete(this.jogadorUrl + "/" + id, options);
    };
    //Crie esse método
    JogadorService.prototype.handleError = function (error) {
        var errMsg;
